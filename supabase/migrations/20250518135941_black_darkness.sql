/*
  # Add personas table and data

  1. New Tables
    - `personas` table for storing persona information
      - `id` (uuid, primary key)
      - `name` (text)
      - `description` (text)
      - `image_url` (text)
  ...
  4. Schema Updates
    - Modify chat_sessions.persona_id to use UUID
...
-- Drop existing foreign key constraints on chat_sessions
